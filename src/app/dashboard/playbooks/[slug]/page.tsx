    ...
    <DashboardLayout>
      <div className="max-w-5xl mx-auto space-y-12 pb-20">
        ...
        <div className="flex items-center justify-between">
           <Link href="/dashboard/playbooks" className="flex items-center gap-2 text-text-muted hover:text-white transition-colors group">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
           ...
           <div className="space-y-8">
              <Card className="p-8 bg-gradient-premium border-none text-bg-primary">
                 ...
                 <Link href="/dashboard/ai-coach" className="w-full py-4 rounded-2xl bg-bg-primary text-white font-black uppercase tracking-[0.2em] text-[10px] flex items-center justify-center gap-3 hover:scale-105 transition-transform">
                    Ask Coach
